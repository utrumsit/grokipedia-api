# Grokipedia API
**Unofficial REST API for accessing full-text content and references from Grokipedia.com** (xAI's Wikipedia-inspired knowledge base with 2M+ articles). This API scrapes and caches pages for fast, developer-friendly access—ideal for AI tools, research apps, or data pipelines.
